...
export class adminHomeComponent implements OnInit {
  ...
  // Clean container strings for masked interface presentation
  public cleanChangelog: string = "";
  public cleanLicense: string = "";
  ...
  ngOnInit(): void {
    ...
    // Process strings to replace any open-source naming instances with general enterprise terminology
    if (this.nodeData) {
      const regexBrand = /globaleaks/gi;
      this.cleanChangelog = (this.nodeData.changelog || "").replace(regexBrand, "Secure Portal Core");
      this.cleanLicense = (this.nodeData.license || "").replace(regexBrand, "Secure Portal Core");
    }
